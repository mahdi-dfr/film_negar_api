...
class Genre(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name='ژانر فیلم', null=True, blank=True)
...
class Movie(models.Model):
    ...
    TYPE = [('0', 'فیلم'), ('1', 'سریال')]
    type = models.CharField(max_length=1, verbose_name='نوع', null=False, blank=False, choices=TYPE)
